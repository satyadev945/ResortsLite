...
public class BookingService {
    ...
    public Map<String, Object> createBooking(String guestName, String roomType,
        ...
        booking.put("dbHost", getSecret("db-host", "externalized-in-key-vault"));
        booking.put("dbUser", getSecret("db-username", "externalized-in-key-vault"));
        return booking;
    }
    ...
    private String getSecret(String secretName, String fallback) {
