...
public class BookingService {
    ...
    // cz-java-0062 [Hardcoded IP Addresses - FIXED]: Hardcoded IP address replaced with
    // environment variable. AWS Service Connect on ECS Fargate enables IP-free inter-container
    // communication via logical service names, removing all hardcoded internal IPs.
