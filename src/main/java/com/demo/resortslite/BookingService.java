...
public class BookingService {
    ...
    // FIX cz-java-0062: Replaced hardcoded IP address (10.0.1.45) with environment variable
    // PAYMENT_SERVICE_URL. AWS Service Connect on ECS Fargate resolves the logical service
    // name at runtime, removing the hardcoded internal IP from inter-container communication.
    @Value("${PAYMENT_SERVICE_URL:http://payment-service/payments/charge}")
