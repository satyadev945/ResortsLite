...
public class BookingService {
    ...
    // cz-java-0062 [Fixed]: Hardcoded IP address replaced with environment variable.
    // The IP 10.0.1.45 is not portable across container deployments; it is externalised
    // to a Kubernetes ConfigMap entry (PAYMENT_API_URL) so AKS pods resolve the correct
    // endpoint at runtime without requiring a code change or image rebuild.
