...
public class BookingService {
    ...
    public Map<String, Object> createBooking(String guestName, String roomType,
        ...
        // MD5 replaced with SHA-256 (Java 17 compatible, stronger hashing algorithm).
        // MD5 is a broken hash algorithm (RFC 6151) — not suitable for security-sensitive use.
    ...
    /**
     * SHA-256 hash helper — replaces the former MD5 implementation.
     * SHA-256 is cryptographically strong and available in all Java SE versions.
     */
