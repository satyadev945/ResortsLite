...
/**
 * JPA entity representing a Doctor record in the JPA_DOCTOR_INFO table.
 * Migrated from javax.persistence to jakarta.persistence for Java 25 / Jakarta EE 10 compatibility.
 */
@Entity
